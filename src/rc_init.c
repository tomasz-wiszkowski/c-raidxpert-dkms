...
static int  rc_ioctl(struct scsi_device * scsi_dev_ptr, unsigned int cmd, void *arg);
...
static NVME_TRAP_DEVICE        NvmeTrapDeviceVar[MAX_HBA - 1];         // One HBA reserved for AHCI(/ATAPI)
